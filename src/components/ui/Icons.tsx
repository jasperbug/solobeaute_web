...
// 單一實心剪影：官方四片式 logo 在 18px 單色下，右側帽蓋會像一支分離的小箭頭，改用整片三角形。
export function GooglePlayIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4.4 1.66a1.2 1.2 0 0 0-1.8 1.04v18.6a1.2 1.2 0 0 0 1.8 1.04l16.26-9.3a1.2 1.2 0 0 0 0-2.08L4.4 1.66Z" />
    </svg>
  )
}
