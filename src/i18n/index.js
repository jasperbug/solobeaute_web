  ...
  zh: {
    translation: {
      ...
      hero: {
        ...
        title1: '你的美業空間',
        title2: '一鍵找到',
        subtitle: '台灣首個整合空間、服務、預約的美業三方 Marketplace',
        cta: '立即下載',
        ctaSub: '開始你的美業之旅',
      },
      ecosystem: {
      ...
      about: {
        sectionTag: '關於我們',
        title: "一起打造\n美業的未來。",
        desc: 'SoloBeauté 相信每位美容職人都值得擁有獨立的舞台。我們讓屋主、職人、消費者都能在這裡找到自己的位置，用行動串起美業的每一個環節。',
        founder: 'Jasper・創辦人',
        founderDesc: '從一個想法到一個產品，從零開始打造 SoloBeauté。相信三方市場的成敗不在技術，在於產業人脈與信任。',
      },
      faq: {
        sectionTag: '常見問題',
        title: '你可能想知道的事',
        items: [
          ...
          { q: '金流怎麼處理？', a: '目前初期階段以現場現金交易為主，確保簡單直接。未來會開通線上安全金流，所有交易都有平台保障。' },
    ...
    translation: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'How are payments handled?', a: 'During the early stage, transactions are handled in cash on-site for simplicity. We will enable secure online payments in the future, all backed by platform protection.' },
    ...
    translation: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: '支払いはどう処理されますか？', a: '初期段階では、シンプルさを重視して現地での現金取引となります。将来的にはプラットフォーム保証付きのオンライン決済を導入予定です。' },
    ...
    translation: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: '결제는 어떻게 처리되나요?', a: '초기 단계에서는 현장 현금 결제로 간편하게 진행됩니다. 향후 플랫폼 보장이 포함된 온라인 안전 결제를 도입할 예정입니다.' },
  ...
  'zh-CN': {
    translation: {
      ...
      hero: {
        ...
        title1: '你的美业空间，',
        title2: '一键找到。',
        subtitle: '台湾首个整合空间、服务、预约的美业三方 Marketplace',
        cta: '立即下载',
        ctaSub: '开始你的美业之旅',
      },
      ecosystem: {
      ...
      about: {
        sectionTag: '关于我们',
        title: "一起打造\n美业的未来。",
        desc: 'SoloBeauté 相信每位美容师都值得拥有独立的舞台。我们让房东、美容师、消费者都能在这里找到自己的位置，用行动串起美业的每一个环节。',
        founder: 'Jasper · 创始人',
        founderDesc: '从一个想法到一个产品，从零开始打造 SoloBeauté。相信三方市场的成败不在技术，在于行业人脉与信任。',
      },
      faq: {
        sectionTag: '常见问题',
        title: '你可能想知道的事',
        items: [
          ...
          { q: '付款怎么处理？', a: '目前初期阶段以现场现金交易为主，确保简单直接。未来会开通线上安全支付，所有交易都有平台保障。' },
    ...
    translation: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'Thanh toán được xử lý như thế nào?', a: 'Trong giai đoạn đầu, giao dịch bằng tiền mặt tại chỗ để đơn giản. Trong tương lai sẽ có thanh toán trực tuyến an toàn với bảo đảm từ nền tảng.' },
    ...
    translation: {
      ...
      faq: {
        ...
        items: [
          ...
          { q: 'การชำระเงินดำเนินการอย่างไร?', a: 'ในช่วงแรกจะเป็นการชำระเงินสดหน้างานเพื่อความสะดวก ในอนาคตจะเปิดระบบชำระเงินออนไลน์ที่ปลอดภัยพร้อมการรับประกันจากแพลตฟอร์ม' },
